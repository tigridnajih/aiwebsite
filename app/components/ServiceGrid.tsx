                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {SOLUTIONS.map((solution, index) => (
                        <motion.div
                            ...
                            className="group flex items-center gap-5 p-7 bg-white rounded-[16px] border border-[rgba(0,102,255,0.05)] transition-all duration-300"
                        >
                            {/* Icon Box */}
                            <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-400 via-blue-600 to-blue-700 rounded-full flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110">
                                {solution.icon}
                            </div>
