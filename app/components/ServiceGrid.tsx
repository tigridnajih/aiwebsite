...
export default function ServiceGrid() {
    return (
        <section className="relative py-24 bg-white overflow-hidden text-slate-900 font-inter">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {SOLUTIONS.map((solution, index) => (
                        <motion.div
                            ...
                            className="group flex items-center gap-5 p-7 bg-white rounded-[16px] border border-[rgba(0,102,255,0.05)] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-4px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1"
                        >
                            {/* Icon Box */}
