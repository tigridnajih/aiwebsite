    ...
    return (
        <section className="relative z-50 py-10 bg-transparent overflow-hidden select-none">
            ...
            <div className="relative w-full flex items-center overflow-hidden">
                ...
                <div className="absolute inset-y-0 left-0 w-[65%] z-20 bg-gradient-to-r from-black via-black/90 to-transparent pointer-events-none" />
                <div className="absolute inset-y-0 right-0 w-[65%] z-20 bg-gradient-to-l from-black via-black/90 to-transparent pointer-events-none" />
