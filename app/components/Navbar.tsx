    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 border-b ${scrolled
      ...
      <div className="container-custom h-full flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <Link
            href="#contact"
            className="px-6 py-2 rounded-full bg-white/10 text-white text-sm font-medium border border-white/10 hover:bg-white/20 transition-all backdrop-blur-sm shadow-lg shadow-purple-500/10"
          >
            Book a Demo
          </Link>
        </div>
