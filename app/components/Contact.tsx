    ...
    return (
        <section id="contact" className="py-24 bg-white dark:bg-black overflow-hidden relative">
            ...
            <div className="container-custom relative z-10 grid md:grid-cols-2 gap-16 items-center">
                <div>
                    <h2 className="text-h2 font-bold mb-6">Ready to Automate Your Growth?</h2>
                    <p className="text-body text-gray-500 mb-8 max-w-md">
                        The future belongs to those who move fast. Book a free strategy session to see specifically how we can help you scale.
                    </p>
