...
const CaseCard = ({ c, index }: { c: typeof cases[0], index: number }) => (
    <motion.div
        ...
        className="sticky w-full bg-[#0d0d0d] rounded-2xl overflow-hidden border-2 border-white/[0.05] shadow-2xl mb-12 hover:border-[#385BFF] transition-all duration-500 group/card"
