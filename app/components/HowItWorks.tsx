                        ...
                        {PHASES.map((phase) => (
                            ...
                            >
                                ...
                                <div className="relative z-10 w-full">
                                    ...
                                    <div className="flex items-center justify-center w-11 h-11 bg-white rounded-full mb-8 shadow-[0_0_20px_rgba(255,255,255,0.05)]">
                                    ...
                                    {/* Title & Description */}
                                    <h3 className="text-xl md:text-2xl font-bold text-white mb-4 tracking-tight group-hover:text-blue-50 transition-colors duration-300">
                                        {phase.title}
                                    </h3>
