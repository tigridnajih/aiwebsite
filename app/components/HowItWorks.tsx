                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 pt-8">
                    {PHASES.map((phase, index) => (
                        <motion.div
                            ...
                            key={phase.step}
                            className="group relative flex flex-col p-8 bg-white rounded-[2.5rem] [box-shadow:0_3px_6px_rgba(0,0,0,0.16),0_3px_6px_rgba(0,0,0,0.23)] transition-all duration-500"
                        >
