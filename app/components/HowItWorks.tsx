            ...
            <div className="container-custom relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative z-10 pt-10">
                    {PHASES.map((phase) => (
                        <div
                            key={phase.number}
                            className="group relative flex flex-col items-start p-6 md:p-8 bg-gradient-to-b from-[#385BFF] to-black rounded-[2.5rem] transition-all duration-300 overflow-hidden"
                        >
