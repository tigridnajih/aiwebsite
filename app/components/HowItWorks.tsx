                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 pt-8">
                    {PHASES.map((phase, index) => (
                        <motion.div
                            ...
                            key={phase.step}
                            className="group relative flex flex-col p-8 bg-white rounded-[2.5rem] border-[1.5px] border-slate-200 [box-shadow:0_10px_20px_-8px_#c5d6d6] transition-all duration-500"
                        >
