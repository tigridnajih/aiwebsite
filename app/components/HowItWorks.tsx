        ...
        <section id="how-it-works" className="py-24 bg-black overflow-hidden">
            <div className="container-custom">
                ...
                <div className="grid lg:grid-cols-3 gap-10 mt-20 pb-20">
                    {/* Card 1: Share Your Workflow - COMPACT MIDNIGHT BLUE ORBS */}
                    <Card
                        number="1"
                            ...
                            <div className="relative w-64 h-64 animate-spin-slow-extremely">
                                ...
                                <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-24 h-24 transform"
                                    ...
                                    <div className="relative w-full h-full bg-[#0B2574] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_4px_12px_rgba(255,255,255,0.15)] border border-blue-500/30 backdrop-blur-sm">
                                        ...
                                        <Mail className="relative z-10 text-white/90 w-8 h-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]" />
                                    </div>
                                </div>

                                {/* 2. List (72deg) - Reduced to w-24 */}
                                <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-24 h-24 transform"
                                    style={{ transform: 'translate(calc(-50% + 35.5px), calc(-50% + 109.4px))' }}>
                                    <div className="relative w-full h-full bg-[#0B2574] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_4px_12px_rgba(255,255,255,0.15)] border border-blue-500/30 backdrop-blur-sm">
                                        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/5 to-transparent pointer-events-none" />
                                        <List className="relative z-10 text-white/90 w-8 h-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]" />
                                    </div>
                                </div>

                                {/* 3. Calendar (144deg) - Reduced to w-24 */}
                                <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-24 h-24 transform"
                                    style={{ transform: 'translate(calc(-50% - 93px), calc(-50% + 67.6px))' }}>
                                    <div className="relative w-full h-full bg-[#0B2574] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_4px_12px_rgba(255,255,255,0.15)] border border-blue-500/30 backdrop-blur-sm">
                                        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/5 to-transparent pointer-events-none" />
                                        <Calendar className="relative z-10 text-white/90 w-8 h-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]" />
                                    </div>
                                </div>

                                {/* 4. NotebookPen (216deg) - Reduced to w-24 */}
                                <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-24 h-24 transform"
                                    style={{ transform: 'translate(calc(-50% - 93px), calc(-50% - 67.6px))' }}>
                                    <div className="relative w-full h-full bg-[#0B2574] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_4px_12px_rgba(255,255,255,0.15)] border border-blue-500/30 backdrop-blur-sm">
                                        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/5 to-transparent pointer-events-none" />
                                        <NotebookPen className="relative z-10 text-white/90 w-8 h-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]" />
                                    </div>
                                </div>

                                {/* 5. FileText (288deg) - Reduced to w-24 */}
                                <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-24 h-24 transform"
                                    style={{ transform: 'translate(calc(-50% + 35.5px), calc(-50% - 109.4px))' }}>
                                    <div className="relative w-full h-full bg-[#0B2574] rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_4px_12px_rgba(255,255,255,0.15)] border border-blue-500/30 backdrop-blur-sm">
                                        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/5 to-transparent pointer-events-none" />
                                        <FileText className="relative z-10 text-white/90 w-8 h-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]" />
                                    </div>
                                </div>
                            </div>
