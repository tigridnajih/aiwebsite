...
export default function Hero() {
    return (
        <section className="relative min-h-screen flex flex-col pt-16 overflow-hidden text-slate-900 bg-white">
            ...
            {/* Bottom gradient mask for smooth transition - Reduced height */}
            <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-t from-white via-white/40 to-transparent z-10" />
