        ...
        <section className="py-20 bg-[#0A0A0A]">
            <div className="container-custom">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {stack.map((item, idx) => (
                        <div key={idx} className="flex flex-col items-center justify-center p-8 bg-white rounded-xl shadow-sm border border-gray-100 hover:border-accent hover:shadow-md transition-all dark:bg-[#111111] dark:border-white/[0.06] shadow-[0_20px_50px_rgba(0,0,0,0.6)]">
