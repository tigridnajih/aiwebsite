                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="relative shrink-0">
                                    ...
                                    <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 flex items-center justify-center shadow-lg ${msg.platform === 'whatsapp' ? 'bg-[#25D366]' : 'bg-blue-500'
