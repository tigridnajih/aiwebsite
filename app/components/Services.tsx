            ...
            mockup: (
                <div className="relative w-full aspect-[4/3] bg-[#080808] rounded-[32px] border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center p-6 md:p-8">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                        <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-green-500/10 blur-[100px] rounded-full" />
                    ...
                    <div className="relative w-full h-full flex items-center gap-4 md:gap-8">
                        ...
                        <div className="flex-[1.8] flex flex-col gap-4">
                            ...
                            <div className="relative bg-gradient-to-br from-[#0D2E1F] to-[#081510] border border-green-500/30 rounded-2xl p-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)] transform hover:-translate-y-1 transition-transform duration-500 group/emma">
                                <div className="flex items-start gap-3">
                                    <div className="relative shrink-0">
                                        ...
                                        <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#25D366] rounded-full border-2 border-[#0D2E1F] flex items-center justify-center shadow-lg">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-center mb-1">
                                            ...
                                            <span className="text-[10px] text-green-400 font-mono opacity-60">09:45 PM</span>
                                        </div>
                                        ...
                                        <div className="mt-2.5 flex items-center gap-2">
                                            <span className="text-green-400 text-[10px] font-bold tracking-wider uppercase">Replying</span>
                                            <span className="flex gap-0.5 items-center">
                                                <span className="w-1 h-1 bg-green-400 rounded-full animate-bounce [animation-duration:1s]" />
                                                <span className="w-1 h-1 bg-green-400 rounded-full animate-bounce [animation-delay:0.2s] [animation-duration:1s]" />
                                                <span className="w-1 h-1 bg-green-400 rounded-full animate-bounce [animation-delay:0.4s] [animation-duration:1s]" />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="flex-[0.5] flex justify-center">
                            <div className="relative">
                                ...
                                {/* Central Node */}
                                <div className="relative w-16 h-16 bg-[#22c55e] rounded-2xl shadow-[0_0_50px_rgba(34,197,94,0.4)] flex items-center justify-center overflow-hidden animate-custom-float">
                                    <div className="w-8 h-8 bg-[#0D2E1F] rounded-lg shadow-inner flex items-center justify-center">
                                        <div className="w-4 h-4 rounded-sm bg-[#22c55e]/30 animate-pulse" />
                                    </div>
